...
def get_datacite_refs(new=True):
    ...
    base_url = 'https://query.eventdata.crossref.org/events?rows=100&filter=source:datacite,relation-type:is_cited_by'
